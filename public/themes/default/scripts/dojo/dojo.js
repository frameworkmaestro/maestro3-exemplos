...
})(this.dojoConfig||this.djConfig||this.require||{},{async:0,hasCache:{"config-selectorEngine":"lite","config-tlmSiblingOfDojo":1,"dojo-built":1,"dojo-loader":1,dom:1,"host-browser":1},packages:[{location:"../dojox",name:"dojox"},{location:"../dgrid",main:"OnDemandGrid",name:"dgrid"},{location:"../dijit",name:"dijit"},{location:"../xstyle",main:"css",name:"xstyle"},{location:".",name:"dojo"},{location:"../manager",name:"manager"},{location:"../put-selector",main:"put",name:"put-selector"}]});
...
var _174=lang.clone(root.root||root.ROOT),_175=_15e(!root._v1x&&root,_173,_171,_172);
_16f(_175,function(){
...
var _2d4=[],_2d5=[{cls:0,refs:[]}],_2d6={},_2d7=1,l=_2d2.length,i=0,j,lin,base,top,_2d8,rec,name,refs;
for(;i<l;++i){
base=_2d2[i];
if(!base){
...
var win=window;
var _4c2={addOnWindowUnload:function(obj,_4c3){
if(!dojo.windowUnloaded){
on(win,"unload",(dojo.windowUnloaded=function(){
}));
}
on(win,"unload",lang.hitch(obj,_4c3));
},addOnUnload:function(obj,_4c4){
on(win,"beforeunload",lang.hitch(obj,_4c4));
}};
dojo.addOnWindowUnload=_4c2.addOnWindowUnload;
dojo.addOnUnload=_4c2.addOnUnload;
return _4c2;
});
},"dojo/loadInit":function(){
define(["./_base/loader"],function(_4c5){
...
define(["./kernel","./lang","./array","./config"],function(dojo,lang,_4fb,_4fc){
var _4fd=dojo.Color=function(_4fe){
if(_4fe){
this.setColor(_4fe);
}
};
_4fd.named={"black":[0,0,0],"silver":[192,192,192],"gray":[128,128,128],"white":[255,255,255],"maroon":[128,0,0],"red":[255,0,0],"purple":[128,0,128],"fuchsia":[255,0,255],"green":[0,128,0],"lime":[0,255,0],"olive":[128,128,0],"yellow":[255,255,0],"navy":[0,0,128],"blue":[0,0,255],"teal":[0,128,128],"aqua":[0,255,255],"transparent":_4fc.transparentColor||[0,0,0,0]};
lang.extend(_4fd,{r:255,g:255,b:255,a:1,_set:function(r,g,b,a){
var t=this;
t.r=r;
t.g=g;
t.b=b;
t.a=a;
},setColor:function(_4ff){
if(lang.isString(_4ff)){
_4fd.fromString(_4ff,this);
}else{
if(lang.isArray(_4ff)){
_4fd.fromArray(_4ff,this);
}else{
this._set(_4ff.r,_4ff.g,_4ff.b,_4ff.a);
if(!(_4ff instanceof _4fd)){
this.sanitize();
}
}
}
...
var arr=_4fb.map(["r","g","b"],function(x){
...
return (_500?"rgba("+rgb+", "+t.a:"rgb("+rgb)+")";
},toString:function(){
return this.toCss(true);
}});
_4fd.blendColors=dojo.blendColors=function(_501,end,_502,obj){
var t=obj||new _4fd();
_4fb.forEach(["r","g","b","a"],function(x){
t[x]=_501[x]+(end[x]-_501[x])*_502;
if(x!="a"){
t[x]=Math.round(t[x]);
}
});
...
_4fd.fromRgb=dojo.colorFromRgb=function(_503,obj){
var m=_503.toLowerCase().match(/^rgba?\(([\s\.,0-9]+)\)/);
return m&&_4fd.fromArray(m[1].split(/\s*,\s*/),obj);
};
_4fd.fromHex=dojo.colorFromHex=function(_504,obj){
var t=obj||new _4fd(),bits=(_504.length==4)?4:8,mask=(1<<bits)-1;
_504=Number("0x"+_504.substr(1));
if(isNaN(_504)){
return null;
}
_4fb.forEach(["b","g","r"],function(x){
var c=_504&mask;
_504>>=bits;
t[x]=bits==4?17*c:c;
});
...
_4fd.fromArray=dojo.colorFromArray=function(a,obj){
var t=obj||new _4fd();
...
_4fd.fromString=dojo.colorFromString=function(str,obj){
var a=_4fd.named[str];
return a&&_4fd.fromArray(a,obj)||_4fd.fromRgb(str,obj)||_4fd.fromHex(str,obj);
};
return _4fd;
});
},"dojo/request":function(){
define(["./request/default!"],function(_505){
return _505;
});
...
var _538=_537.matchesSelector||_537.webkitMatchesSelector||_537.mozMatchesSelector||_537.msMatchesSelector||_537.oMatchesSelector;
var _539=_537.querySelectorAll;
var _53a=/([^\s,](?:"(?:\\.|[^"])+"|'(?:\\.|[^'])+'|[^,])*)/g;
has.add("dom-matches-selector",!!_538);
has.add("dom-qsa",!!_539);
var _53b=function(_53c,root){
if(_53d&&_53c.indexOf(",")>-1){
return _53d(_53c,root);
}
var doc=root?root.ownerDocument||root:dojo.doc||document,_53e=(_539?/^([\w]*)#([\w\-]+$)|^(\.)([\w\-\*]+$)|^(\w+$)/:/^([\w]*)#([\w\-]+)(?:\s+(.*))?$|(?:^|(>|.+\s+))([\w\-\*]+)(\S*$)/).exec(_53c);
root=root||doc;
if(_53e){
if(_53e[2]){
var _53f=dojo.byId?dojo.byId(_53e[2],doc):doc.getElementById(_53e[2]);
if(!_53f||(_53e[1]&&_53e[1]!=_53f.tagName.toLowerCase())){
return [];
}
if(root!=doc){
var _540=_53f;
while(_540!=root){
_540=_540.parentNode;
if(!_540){
return [];
}
}
}
return _53e[3]?_53b(_53e[3],_53f):[_53f];
}
if(_53e[3]&&root.getElementsByClassName){
return root.getElementsByClassName(_53e[4]);
}
var _53f;
if(_53e[5]){
_53f=root.getElementsByTagName(_53e[5]);
if(_53e[4]||_53e[6]){
_53c=(_53e[4]||"")+_53e[6];
}else{
return _53f;
...
return _541(root,_53c,root.querySelectorAll);
}else{
return root.querySelectorAll(_53c);
}
}else{
if(!_53f){
_53f=root.getElementsByTagName("*");
}
}
var _542=[];
for(var i=0,l=_53f.length;i<l;i++){
var node=_53f[i];
if(node.nodeType==1&&_543(node,_53c,root)){
_542.push(node);
}
}
return _542;
};
var _541=function(_544,_545,_546){
var _547=_544,old=_544.getAttribute("id"),nid=old||"__dojo__",_548=_544.parentNode,_549=/^\s*[+~]/.test(_545);
if(_549&&!_548){
return [];
}
if(!old){
_544.setAttribute("id",nid);
}else{
nid=nid.replace(/'/g,"\\$&");
}
if(_549&&_548){
_544=_544.parentNode;
}
var _54a=_545.match(_53a);
for(var i=0;i<_54a.length;i++){
_54a[i]="[id='"+nid+"'] "+_54a[i];
}
_545=_54a.join(",");
try{
return _546.call(_544,_545);
}
finally{
if(!old){
_547.removeAttribute("id");
}
}
};
if(!has("dom-matches-selector")){
var _543=(function(){
var _54b=_537.tagName=="div"?"toLowerCase":"toUpperCase";
var _54c={"":function(_54d){
_54d=_54d[_54b]();
return function(node){
return node.tagName==_54d;
};
},".":function(_54e){
var _54f=" "+_54e+" ";
return function(node){
return node.className.indexOf(_54e)>-1&&(" "+node.className+" ").indexOf(_54f)>-1;
};
},"#":function(id){
return function(node){
return node.id==id;
...
return _551.indexOf(_552)==0;
},"*=":function(_553,_554){
return _553.indexOf(_554)>-1;
},"$=":function(_555,_556){
return _555.substring(_555.length-_556.length,_555.length)==_556;
},"~=":function(_557,_558){
return (" "+_557+" ").indexOf(" "+_558+" ")>-1;
},"|=":function(_559,_55a){
return (_559+"-").indexOf(_55a+"-")==0;
},"=":function(_55b,_55c){
return _55b==_55c;
},"":function(_55d,_55e){
return true;
}};
function attr(name,_55f,type){
var _560=_55f.charAt(0);
if(_560=="\""||_560=="'"){
_55f=_55f.slice(1,-1);
}
_55f=_55f.replace(/\\/g,"");
var _561=_550[type||""];
return function(node){
var _562=node.getAttribute(name);
return _562&&_561(_562,_55f);
};
};
function _563(_564){
...
return function(node,root){
node=node.parentNode;
return _566?node!=root&&_566(node,root):node==root;
};
};
var _567={};
function and(_568,next){
return _568?function(node,root){
return next(node)&&_568(node,root);
}:next;
};
return function(node,_569,root){
var _56a=_567[_569];
if(!_56a){
if(_569.replace(/(?:\s*([> ])\s*)|(#|\.)?((?:\\.|[\w-])+)|\[\s*([\w-]+)\s*(.?=)?\s*("(?:\\.|[^"])+"|'(?:\\.|[^'])+'|(?:\\.|[^\]])*)\s*\]/g,function(t,_56b,type,_56c,_56d,_56e,_56f){
if(_56c){
_56a=and(_56a,_54c[type||""](_56c.replace(/\\/g,"")));
}else{
if(_56b){
_56a=(_56b==" "?_563:_565)(_56a);
}else{
if(_56d){
_56a=and(_56a,attr(_56d,_56f,_56e));
}
}
}
return "";
...
return _56a(node,root);
};
})();
}
if(!has("dom-qsa")){
var _53d=function(_570,root){
var _571=_570.match(_53a);
var _572=[];
for(var i=0;i<_571.length;i++){
_570=new String(_571[i].replace(/\s*$/,""));
_570.indexOf=escape;
var _573=_53b(_570,root);
for(var j=0,l=_573.length;j<l;j++){
var node=_573[j];
_572[node.sourceIndex]=node;
}
}
var _574=[];
for(i in _572){
...
_53b.match=_538?function(node,_575,root){
if(root&&root.nodeType!=9){
return _541(root,_575,function(_576){
return _538.call(node,_576);
});
}
return _538.call(node,_575);
}:_543;
return _53b;
});
},"dojo/on":function(){
define(["./has!dom-addeventlistener?:./aspect","./_base/kernel","./sniff"],function(_577,dojo,has){
"use strict";
if(1){
var _578=window.ScriptEngineMajorVersion;
has.add("jscript",_578&&(_578()+ScriptEngineMinorVersion()/10));
has.add("event-orientationchange",has("touch")&&!has("android"));
has.add("event-stopimmediatepropagation",window.Event&&!!window.Event.prototype&&!!window.Event.prototype.stopImmediatePropagation);
has.add("event-focusin",function(_579,doc,_57a){
return "onfocusin" in _57a||(_57a.addEventListener&&(function(){
var _57b=false;
function _57c(){
_57b=true;
};
try{
var _57d=doc.createElement("input"),_57e=doc.activeElement;
_57d.style.position="fixed";
_57d.addEventListener("focusin",_57c,false);
doc.body.appendChild(_57d);
_57d.focus();
doc.body.removeChild(_57d);
_57d.removeEventListener("focusin",_57c,false);
_57e.focus();
}
catch(e){
}
...
var on=function(_57f,type,_580,_581){
if(typeof _57f.on=="function"&&typeof type!="function"&&!_57f.nodeType){
return _57f.on(type,_580);
}
return on.parse(_57f,type,_580,_582,_581,this);
};
on.pausable=function(_583,type,_584,_585){
var _586;
var _587=on(_583,type,function(){
if(!_586){
return _584.apply(this,arguments);
}
},_585);
_587.pause=function(){
_586=true;
};
_587.resume=function(){
_586=false;
};
return _587;
};
on.once=function(_588,type,_589,_58a){
var _58b=on(_588,type,function(){
_58b.remove();
return _589.apply(this,arguments);
});
return _58b;
};
on.parse=function(_58c,type,_58d,_58e,_58f,_590){
if(type.call){
return type.call(_590,_58c,_58d);
}
if(type.indexOf(",")>-1){
var _591=type.split(/\s*,\s*/);
var _592=[];
var i=0;
var _593;
while(_593=_591[i++]){
_592.push(_58e(_58c,_593,_58d,_58f,_590));
}
_592.remove=function(){
...
return _58e(_58c,type,_58d,_58f,_590);
};
var _594=/^touch/;
function _582(_595,type,_596,_597,_598){
var _599=type.match(/(.*):(.*)/);
if(_599){
type=_599[2];
_599=_599[1];
return on.selector(_599,type).call(_598,_595,_596);
}
if(has("touch")){
if(_594.test(type)){
_596=_59a(_596);
...
if(_595.addEventListener){
var _59c=type in _59d,_59e=_59c?_59d[type]:type;
_595.addEventListener(_59e,_596,_59c);
return {remove:function(){
_595.removeEventListener(_59e,_596,_59c);
}};
}
type="on"+type;
if(_59f&&_595.attachEvent){
return _59f(_595,type,_596);
}
throw new Error("Target must be an event emitter");
};
on.selector=function(_5a0,_5a1,_5a2){
return function(_5a3,_5a4){
var _5a5=typeof _5a0=="function"?{matches:_5a0}:this,_5a6=_5a1.bubble;
function _5a7(_5a8){
_5a5=_5a5&&_5a5.matches?_5a5:dojo.query;
while(!_5a5.matches(_5a8,_5a0,_5a3)){
if(_5a8==_5a3||_5a2===false||!(_5a8=_5a8.parentNode)||_5a8.nodeType!=1){
return;
}
}
return _5a8;
...
if(_5a6){
return on(_5a3,_5a6(_5a7),_5a4);
}
return on(_5a3,_5a1,function(_5a9){
var _5aa=_5a7(_5a9.target);
return _5aa&&_5a4.call(_5aa,_5a9);
});
};
};
function _5ab(){
...
var _5ad=[].slice,_5ae=on.emit=function(_5af,type,_5b0){
var args=_5ad.call(arguments,2);
var _5b1="on"+type;
if("parentNode" in _5af){
var _5b2=args[0]={};
for(var i in _5b0){
_5b2[i]=_5b0[i];
}
_5b2.preventDefault=_5ab;
_5b2.stopPropagation=_5ac;
_5b2.target=_5af;
_5b2.type=type;
_5b0=_5b2;
}
do{
_5af[_5b1]&&_5af[_5b1].apply(_5af,args);
}while(_5b0&&_5b0.bubbles&&(_5af=_5af.parentNode));
return _5b0&&_5b0.cancelable&&_5b0;
};
var _59d=has("event-focusin")?{}:{focusin:"focus",focusout:"blur"};
if(!has("event-stopimmediatepropagation")){
var _5b3=function(){
this.immediatelyStopped=true;
this.modified=true;
};
var _59b=function(_5b4){
return function(_5b5){
if(!_5b5.immediatelyStopped){
_5b5.stopImmediatePropagation=_5b3;
return _5b4.apply(this,arguments);
}
};
};
}
if(has("dom-addeventlistener")){
on.emit=function(_5b6,type,_5b7){
if(_5b6.dispatchEvent&&document.createEvent){
var _5b8=_5b6.ownerDocument.createEvent("HTMLEvents");
_5b8.initEvent(type,!!_5b7.bubbles,!!_5b7.cancelable);
for(var i in _5b7){
if(!(i in _5b8)){
_5b8[i]=_5b7[i];
}
}
return _5b6.dispatchEvent(_5b8)&&_5b8;
}
return _5ae.apply(on,arguments);
};
}else{
on._fixEvent=function(evt,_5b9){
if(!evt){
var w=_5b9&&(_5b9.ownerDocument||_5b9.document||_5b9).parentWindow||window;
evt=w.event;
}
if(!evt){
return evt;
...
try{
if(_5ba&&evt.type==_5ba.type&&evt.srcElement==_5ba.target){
evt=_5ba;
}
}
catch(e){
...
evt.currentTarget=(_5b9||evt.srcElement);
...
evt.stopPropagation=_5bb;
evt.preventDefault=_5bc;
}
switch(evt.type){
case "keypress":
...
var _5ba,_5be=function(_5bf){
this.handle=_5bf;
};
_5be.prototype.remove=function(){
delete _dojoIEListeners_[this.handle];
};
var _5c0=function(_5c1){
return function(evt){
evt=on._fixEvent(evt,this);
var _5c2=_5c1.call(this,evt);
if(evt.modified){
if(!_5ba){
setTimeout(function(){
_5ba=null;
...
var _59f=function(_5c3,type,_5c4){
_5c4=_5c0(_5c4);
if(((_5c3.ownerDocument?_5c3.ownerDocument.parentWindow:_5c3.parentWindow||_5c3.window||window)!=top||has("jscript")<5.8)&&!has("config-_allow_leaks")){
if(typeof _dojoIEListeners_=="undefined"){
_dojoIEListeners_=[];
}
var _5c5=_5c3[type];
if(!_5c5||!_5c5.listeners){
var _5c6=_5c5;
_5c5=Function("event","var callee = arguments.callee; for(var i = 0; i<callee.listeners.length; i++){var listener = _dojoIEListeners_[callee.listeners[i]]; if(listener){listener.call(this,event);}}");
_5c5.listeners=[];
_5c3[type]=_5c5;
_5c5.global=this;
if(_5c6){
_5c5.listeners.push(_dojoIEListeners_.push(_5c6)-1);
}
}
var _5c7;
_5c5.listeners.push(_5c7=(_5c5.global._dojoIEListeners_.push(_5c4)-1));
return new _5be(_5c7);
}
return _577.after(_5c3,type,_5c4,true);
};
var _5bd=function(evt){
...
var _5bc=on._preventDefault=function(){
...
var _5c9=window.orientation;
var _59a=function(_5ca){
return function(_5cb){
var _5cc=_5cb.corrected;
if(!_5cc){
var type=_5cb.type;
try{
delete _5cb.type;
...
_5cc.preventDefault=function(){
_5cb.preventDefault();
};
_5cc.stopPropagation=function(){
_5cb.stopPropagation();
};
}else{
_5cc=_5cb;
_5cc.type=type;
...
_5cb.corrected=_5cc;
if(type=="resize"){
if(_5c9==window.orientation){
return null;
}
_5c9=window.orientation;
_5cc.type="orientationchange";
return _5ca.call(this,_5cc);
}
if(!("rotation" in _5cc)){
_5cc.rotation=0;
_5cc.scale=1;
}
var _5cd=_5cc.changedTouches[0];
for(var i in _5cd){
delete _5cc[i];
_5cc[i]=_5cd[i];
}
...
define(["../_base/lang"],function(lang){
return function(name,ctor,base,_5ce){
base=base||Error;
var _5cf=function(_5d0){
if(base===Error){
if(Error.captureStackTrace){
Error.captureStackTrace(this,_5cf);
}
var err=Error.call(this,_5d0),prop;
for(prop in err){
...
_5cf.prototype=lang.delegate(base.prototype,_5ce);
_5cf.prototype.name=name;
_5cf.prototype.constructor=_5cf;
return _5cf;
};
});
...
var _5d1={},u;
function _5d2(fn){
return _5d1[fn]=new Function("item","index","array",fn);
};
function _5d3(some){
var _5d4=!some;
return function(a,fn,o){
var i=0,l=a&&a.length||0,_5d5;
...
function _5d6(up){
var _5d7=1,_5d8=0,_5d9=0;
if(!up){
_5d7=_5d8=_5d9=-1;
}
return function(a,x,from,last){
if(last&&_5d7>0){
return _5da.lastIndexOf(a,x,from);
}
var l=a&&a.length||0,end=up?l+_5d9:_5d8,i;
if(from===u){
i=up?_5d8:l+_5d9;
}else{
if(from<0){
...
var _5da={every:_5d3(false),some:_5d3(true),indexOf:_5d6(true),lastIndexOf:_5d6(false),forEach:function(arr,_5db,_5dc){
var i=0,l=arr&&arr.length||0;
if(l&&typeof arr=="string"){
arr=arr.split("");
}
if(typeof _5db=="string"){
_5db=_5d1[_5db]||_5d2(_5db);
}
if(_5dc){
for(;i<l;++i){
_5db.call(_5dc,arr[i],i,arr);
}
}else{
for(;i<l;++i){
_5db(arr[i],i,arr);
...
},map:function(arr,_5dd,_5de,Ctr){
var i=0,l=arr&&arr.length||0,out=new (Ctr||Array)(l);
if(l&&typeof arr=="string"){
arr=arr.split("");
}
if(typeof _5dd=="string"){
_5dd=_5d1[_5dd]||_5d2(_5dd);
}
if(_5de){
for(;i<l;++i){
out[i]=_5dd.call(_5de,arr[i],i,arr);
}
}else{
for(;i<l;++i){
out[i]=_5dd(arr[i],i,arr);
}
}
return out;
},filter:function(arr,_5df,_5e0){
var i=0,l=arr&&arr.length||0,out=[],_5e1;
if(l&&typeof arr=="string"){
arr=arr.split("");
}
if(typeof _5df=="string"){
_5df=_5d1[_5df]||_5d2(_5df);
}
if(_5e0){
for(;i<l;++i){
_5e1=arr[i];
if(_5df.call(_5e0,_5e1,i,arr)){
out.push(_5e1);
}
}
}else{
...
dojo.toJson=function(it,_5e2){
return json.stringify(it,function(key,_5e3){
if(_5e3){
var tf=_5e3.__json__||_5e3.json;
if(typeof tf=="function"){
return tf.call(_5e3);
}
}
return _5e3;
},_5e2&&dojo.toJsonIndentStr);
};
return dojo;
});
...
},setContext:function(_5e4,_5e5){
dojo.global=ret.global=_5e4;
dojo.doc=ret.doc=_5e5;
},withGlobal:function(_5e6,_5e7,_5e8,_5e9){
var _5ea=dojo.global;
try{
dojo.global=ret.global=_5e6;
return ret.withDoc.call(null,_5e6.document,_5e7,_5e8,_5e9);
}
finally{
dojo.global=ret.global=_5ea;
}
},withDoc:function(_5eb,_5ec,_5ed,_5ee){
var _5ef=ret.doc,oldQ=has("quirks"),_5f0=has("ie"),isIE,mode,pwin;
try{
dojo.doc=ret.doc=_5eb;
dojo.isQuirks=has.add("quirks",dojo.doc.compatMode=="BackCompat",true,true);
if(has("ie")){
if((pwin=_5eb.parentWindow)&&pwin.navigator){
isIE=parseFloat(pwin.navigator.appVersion.split("MSIE ")[1])||undefined;
mode=_5eb.documentMode;
...
if(_5ed&&typeof _5ec=="string"){
_5ec=_5ed[_5ec];
}
return _5ec.apply(_5ed,_5ee||[]);
}
finally{
dojo.doc=ret.doc=_5ef;
dojo.isQuirks=has.add("quirks",oldQ,true,true);
dojo.isIE=has.add("ie",_5f0,true,true);
}
}};
...
define(["./_base/lang","./_base/array","./dom"],function(lang,_5f1,dom){
var _5f2="className";
var cls,_5f3=/\s+/,a1=[""];
function _5f4(s){
...
return _5f1.filter(s,function(x){
return x;
});
};
var _5f5={};
cls={contains:function containsClass(node,_5f6){
return ((" "+dom.byId(node)[_5f2]+" ").indexOf(" "+_5f6+" ")>=0);
},add:function addClass(node,_5f7){
node=dom.byId(node);
_5f7=_5f4(_5f7);
var cls=node[_5f2],_5f8;
cls=cls?" "+cls+" ":" ";
_5f8=cls.length;
for(var i=0,len=_5f7.length,c;i<len;++i){
c=_5f7[i];
...
if(_5f8<cls.length){
node[_5f2]=cls.substr(1,cls.length-2);
}
},remove:function removeClass(node,_5f9){
node=dom.byId(node);
var cls;
if(_5f9!==undefined){
_5f9=_5f4(_5f9);
cls=" "+node[_5f2]+" ";
for(var i=0,len=_5f9.length;i<len;++i){
cls=cls.replace(" "+_5f9[i]+" "," ");
}
cls=lang.trim(cls);
}else{
cls="";
...
},replace:function replaceClass(node,_5fa,_5fb){
node=dom.byId(node);
_5f5[_5f2]=node[_5f2];
cls.remove(_5f5,_5fb);
cls.add(_5f5,_5fa);
if(node[_5f2]!==_5f5[_5f2]){
node[_5f2]=_5f5[_5f2];
}
},toggle:function toggleClass(node,_5fc,_5fd){
node=dom.byId(node);
if(_5fd===undefined){
_5fc=_5f4(_5fc);
for(var i=0,len=_5fc.length,c;i<len;++i){
c=_5fc[i];
cls[cls.contains(node,c)?"remove":"add"](node,c);
}
}else{
cls[_5fd?"add":"remove"](node,_5fc);
}
return _5fd;
}};
return cls;
...
define(["../has","require"],function(has,_5fe){
var _5ff={};
if(1){
var src=_5fe.rawConfig,p;
for(p in src){
_5ff[p]=src[p];
}
}else{
var _600=function(_601,_602,_603){
for(p in _601){
p!="has"&&has.add(_602+p,_601[p],0,_603);
}
};
_5ff=1?_5fe.rawConfig:this.dojoConfig||this.djConfig||{};
_600(_5ff,"config",1);
_600(_5ff.has,"",1);
}
if(!_5ff.locale&&typeof navigator!="undefined"){
_5ff.locale=(navigator.language||navigator.userLanguage).toLowerCase();
}
return _5ff;
});
...
var ret={fix:function(evt,_605){
if(on._fixEvent){
return on._fixEvent(evt,_605);
}
return evt;
},stop:function(evt){
...
define(["./_base/kernel","./has","require","./sniff","./_base/lang","./_base/array","./_base/config","./ready","./_base/declare","./_base/connect","./_base/Deferred","./_base/json","./_base/Color","./has!dojo-firebug?./_firebug/firebug","./_base/browser","./_base/loader"],function(_606,has,_607,_608,lang,_609,_60a,_60b){
if(_60a.isDebug){
_607(["./_firebug/firebug"]);
}
1||has.add("dojo-config-require",1);
if(1){
var deps=_60a.require;
if(deps){
deps=_609.map(lang.isArray(deps)?deps:[deps],function(item){
...
define(["../json","../_base/kernel","../_base/array","../has","../selector/_loader"],function(JSON,_60c,_60d,has){
has.add("activex",typeof ActiveXObject!=="undefined");
has.add("dom-parser",function(_60e){
return "DOMParser" in _60e;
});
var _60f;
if(has("activex")){
...
_60f=function(_610){
var _611=_610.data;
if(_611&&has("dom-qsa2.1")&&!_611.querySelectorAll&&has("dom-parser")){
_611=new DOMParser().parseFromString(_610.text,"application/xml");
}
if(!_611||!_611.documentElement){
var text=_610.text;
_60d.some(dp,function(p){
try{
var dom=new ActiveXObject(p);
dom.async=false;
dom.loadXML(text);
...
var _612={"javascript":function(_613){
return _60c.eval(_613.text||"");
},"json":function(_614){
return JSON.parse(_614.text||null);
},"xml":_60f};
function _615(_616){
var _617=_612[_616.options.handleAs];
_616.data=_617?_617(_616):(_616.data||_616.text);
return _616;
};
_615.register=function(name,_618){
_612[name]=_618;
};
return _615;
});
...
"use strict";
var _619,_61a=0;
function _61b(_61c,type,_61d,_61e){
var _61f=_61c[type];
var _620=type=="around";
var _621;
if(_620){
var _622=_61d(function(){
return _61f.advice(this,arguments);
});
_621={remove:function(){
if(_622){
_622=_61c=_61d=null;
}
},advice:function(_623,args){
return _622?_622.apply(_623,args):_61f.advice(_623,args);
}};
}else{
_621={remove:function(){
if(_621.advice){
var _624=_621.previous;
var next=_621.next;
if(!next&&!_624){
delete _61c[type];
}else{
...
_61c=_61d=_621.advice=null;
}
},id:_61a++,advice:_61d,receiveArguments:_61e};
}
if(_61f&&!_620){
if(type=="after"){
while(_61f.next&&(_61f=_61f.next)){
}
_61f.next=_621;
_621.previous=_61f;
}else{
...
function _625(type){
return function(_626,_627,_628,_629){
var _62a=_626[_627],_62b;
if(!_62a||_62a.target!=_626){
_626[_627]=_62b=function(){
var _62c=_61a;
var args=arguments;
var _62d=_62b.before;
while(_62d){
args=_62d.advice.apply(this,args)||args;
_62d=_62d.next;
}
if(_62b.around){
var _62e=_62b.around.advice(this,args);
}
var _62f=_62b.after;
while(_62f&&_62f.id<_62c){
if(_62f.receiveArguments){
var _630=_62f.advice.apply(this,args);
_62e=_630===_619?_62e:_630;
}else{
_62e=_62f.advice.call(this,_62e,args);
}
_62f=_62f.next;
}
return _62e;
...
if(_62a){
_62b.around={advice:function(_631,args){
return _62a.apply(_631,args);
}};
}
_62b.target=_626;
}
var _632=_61b((_62b||_62a),type,_628,_629);
_628=null;
return _632;
};
};
var _633=_625("after");
var _634=_625("before");
var _635=_625("around");
return {before:_634,around:_635,after:_633};
});
},"dojo/_base/connect":function(){
define(["./kernel","../on","../topic","../aspect","./event","../mouse","./sniff","./lang","../keys"],function(dojo,on,hub,_636,_637,_638,has,lang){
has.add("events-keypress-typed",function(){
var _639={charCode:0};
try{
_639=document.createEvent("KeyboardEvent");
(_639.initKeyboardEvent||_639.initKeyEvent).call(_639,"keypress",true,true,null,false,false,false,false,9,3);
}
catch(e){
}
return _639.charCode==0&&!has("opera");
});
function _63a(obj,_63b,_63c,_63d,_63e){
_63d=lang.hitch(_63c,_63d);
if(!obj||!(obj.addEventListener||obj.attachEvent)){
return _636.after(obj||dojo.global,_63b,_63d,true);
}
if(typeof _63b=="string"&&_63b.substring(0,2)=="on"){
_63b=_63b.substring(2);
}
if(!obj){
obj=dojo.global;
}
...
return on(obj,_63b,_63d,_63e);
};
var _640={106:42,111:47,186:59,187:43,188:44,189:45,190:46,191:47,192:96,219:91,220:92,221:93,222:39,229:113};
var _641=has("mac")?"metaKey":"ctrlKey";
var _642=function(evt,_643){
var faux=lang.mixin({},evt,_643);
_644(faux);
...
_63f=function(_646,_647){
var _648=on(_646,"keydown",function(evt){
var k=evt.keyCode;
var _649=(k!=13)&&k!=32&&(k!=27||!has("ie"))&&(k<48||k>90)&&(k<96||k>111)&&(k<186||k>192)&&(k<219||k>222)&&k!=229;
if(_649||evt.ctrlKey){
var c=_649?0:k;
if(evt.ctrlKey){
if(k==3||k==13){
return _647.call(evt.currentTarget,evt);
}else{
if(c>95&&c<106){
c-=48;
}else{
...
var faux=_642(evt,{type:"keypress",faux:true,charCode:c});
_647.call(evt.currentTarget,faux);
if(has("ie")){
_645(evt,faux.keyCode);
}
}
});
var _64a=on(_646,"keypress",function(evt){
var c=evt.charCode;
c=c>=32?c:0;
evt=_642(evt,{charCode:c,faux:true});
return _647.call(this,evt);
});
return {remove:function(){
_648.remove();
_64a.remove();
...
if(has("opera")){
_63f=function(_64b,_64c){
return on(_64b,"keypress",function(evt){
var c=evt.which;
if(c==3){
c=99;
}
...
return _64c.call(this,_642(evt,{charCode:c}));
});
};
}else{
_63f=function(_64d,_64e){
return on(_64d,"keypress",function(evt){
_644(evt);
return _64e.call(this,evt);
});
};
}
}
var _64f={_keypress:_63f,connect:function(obj,_650,_651,_652,_653){
...
return _63a.apply(this,args);
},disconnect:function(_654){
if(_654){
_654.remove();
}
},subscribe:function(_655,_656,_657){
return hub.subscribe(_655,lang.hitch(_656,_657));
},publish:function(_658,args){
return hub.publish.apply(hub,[_658].concat(args));
},connectPublisher:function(_659,obj,_65a){
var pf=function(){
_64f.publish(_659,arguments);
};
return _65a?_64f.connect(obj,_65a,pf):_64f.connect(obj,pf);
},isCopyKey:function(e){
return e[_641];
}};
_64f.unsubscribe=_64f.disconnect;
1&&lang.mixin(dojo,_64f);
return _64f;
});
},"dojo/ready":function(){
define(["./_base/kernel","./has","require","./domReady","./_base/lang"],function(dojo,has,_65b,_65c,lang){
var _65d=0,_65e=[],_65f=0,_660=function(){
_65d=1;
...
_65f=1;
while(_65d&&(!_65c||_65c._Q.length==0)&&(_65b.idle?_65b.idle():true)&&_65e.length){
var f=_65e.shift();
try{
f();
}
...
_65b.on&&_65b.on("idle",_661);
if(_65c){
_65c._onQEmpty=_661;
}
var _662=dojo.ready=dojo.addOnLoad=function(_663,_664,_665){
var _666=lang._toArray(arguments);
if(typeof _663!="number"){
_665=_664;
_664=_663;
_663=1000;
}else{
...
_665=_665?lang.hitch.apply(dojo,_666):function(){
_664();
};
_665.priority=_663;
for(var i=0;i<_65e.length&&_663>=_65e[i].priority;i++){
}
_65e.splice(i,0,_665);
_661();
};
...
if(dca){
_662[(lang.isArray(dca)?"apply":"call")](dojo,dca);
}
}
...
define(["./create"],function(_667){
return _667("CancelError",null,null,{dojoType:"cancel"});
});
}}});
(function(){
var _668=this.require;
_668({cache:{}});
!_668.async&&_668(["dojo"]);
_668.boot&&_668.apply(null,_668.boot);
})();
