...
class gridInputExemplo extends MGridInput {
    ...
    public function grid1() {
        ...
        $grid = new MObjectGrid('gridInputExemploGrid1', $array, null, '', 0, 3);
        $grid->addActionSelect('marca1');
        $grid->addActionUpdate('!gridInputExemplo1.edit(#3#);');
        $grid->addActionDelete('!gridInputExemplo1.remove(#3#);');
    ...
    public function grid2() {
        ...
        $grid->addColumn(new MObjectGridColumn('id', '', 'left', true, '0%', false));
        $grid->addActionIcon('$alt', 'Edit', '!gridInputExemplo2.edit(#1#);', 2);
